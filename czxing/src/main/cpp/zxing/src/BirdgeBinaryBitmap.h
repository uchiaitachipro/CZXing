...
*/
class BirdgeBinaryBitmap : public GlobalHistogramBinarizer
{
public:
	explicit BirdgeBinaryBitmap(const std::shared_ptr<const LuminanceSource>& source, bool pureBarcode = false);
	~BirdgeBinaryBitmap() override;
