...
static int qt_UnicodeToGb18030(unsigned uni, uint8_t *gbchar) {
	...
	if (uni < 0x80) {
		*gbchar = (uint8_t)uni;
		...
		// Surrogate rect and other undefined/reserved areas (discard)
		*gbchar = 0;
		return 0;
	}
...
void GBTextEncoder::EncodeGB18030(const std::wstring& str, std::string& bytes)
{
	...
	for (size_t i = 0; i < str.length(); ++i) {
		...
		if (ch < 0x80) {
			...
			// surrogates rect. check for correct encoding
