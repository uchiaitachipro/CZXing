...
enum
{
    ...
    CV_CAP_PROP_XI_OFFSET_X                                     = 402, // Horizontal offset from the origin to the rect of interest (in pixels).
    CV_CAP_PROP_XI_OFFSET_Y                                     = 403, // Vertical offset from the origin to the rect of interest (in pixels).
